...
global esc %vetor com as quantidades de escoras possiveis
num_esc = esc(round(xvar(18)));%num total de escoras
...
for el_esc=1:n_el_cv
    ...
    elseif el_esc >= num_nos_cv && (el_esc + 2 - num_nos_cv) <= (num_nos_cv / 2)
        conec_esc(el_esc,2) = Areas(round(xvar(19))) * 2;    %área cantoneira dupla
...
assignin('base','perfil_esc',round(xvar(18)))
