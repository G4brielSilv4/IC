...
NIterations=10;         % maximum number of iterations (it_max)
...
for largura=1:1
    for rodada=1:n_iteracoes
        ...
        disp('*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*')   
        disp('custo')
        disp(preco_final); %xvar 5
        disp(' ')
        
        disp('tipo telha')
        disp(tipo_telha); %xvar 5
        disp(' ')
        
        disp('tipo terca')
        disp(tipo_terca); %xvar 6
        disp(' ')
        ...
        disp('espacamento entre porticos')
        disp(esp_ent_port); %xvar 6
        disp(' ')
        
        disp('numero de tercas')
        disp(num_tercas); %xvar 6
        disp(' ')
        
        disp('numero contraventamentos')
        disp(num_cont); %xvar 6
        disp(' ')
        
        disp('perfil cantoneira moa francesa')
        disp(perfil_cant); %xvar 6
        ...
        disp(' ')
        disp(['O diâmetro do tirante X: ',num2str(diametro_tirante_x*100),' cm'])
