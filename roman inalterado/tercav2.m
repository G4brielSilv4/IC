function [ppterca,preco_terca_sec,penalidade,peso_terca_sec,area_terca] = tercav2 (perfil_terca,carga_telha,tirante,sc,esp_terca,p,incl,Cpi2,espacamento_entre_porticos,E,fy,n_tercas,pp_mao_francesa,comprimento_mao_francesa)
%Considerações 
...
PPU= ppU + carga_telha*esp_terca + tirante; %N/m 
